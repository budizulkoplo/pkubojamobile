...
Route::get('/firebase-messaging-sw.js', [NotificationController::class, 'firebaseMessagingSw']);
...
Route::middleware(['auth:karyawan'])->group(function () {
    ...
    Route::post('/notifications/fcm-token', [NotificationController::class, 'storeToken'])->name('notifications.fcm-token');
