...
<div class="p-3" style="margin-top:30px">
    ...
    <div class="row">
        <div class="col">
            ...
            <label class="mt-2">Alasan Lembur</label>
            <input type="text" id="alasan" class="form-control mb-3" placeholder="Tuliskan alasan lembur..." required>

            <div class="section-title">Ambil Foto Absen Lembur</div>
            <input type="hidden" id="lokasi">

            <div class="webcam-capture mt-2">
...
function prosesAbsen(mode) {
    ...
    if (alasan === "") {
        Swal.fire(
            'Alasan Wajib Diisi!',
            'Silakan tuliskan alasan lembur terlebih dahulu.',
            'warning'
        );
        return;
    }
    ...
    $.ajax({
        type: 'POST',
        url: "{{ route('hris.ajukan_lembur_store') }}",
        data: {
            _token: "{{ csrf_token() }}",
            mode: mode,
            lokasi: lokasi,
