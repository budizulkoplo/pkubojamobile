...
<body>
    ...
    <table>
        ...
        @if($tugasluar > 0)
        <tr>
            <td class="label">Tugas Luar <span class="text-muted small">{{ $tugasluar }} × Rp {{ number_format($kehadiran, 0, ',', '.') }}</span></td>
            <td class="value">Rp {{ number_format($tugasluar * $kehadiran, 0, ',', '.') }}</td>
        </tr>
        @endif
