...
if ($isHarian || $isTraining) $uangMakan = 0;
...
if ($isTraining) {
    ...
    $zis = $pph21 = $qurban = $potransport = $infaqPdm = $infaqTerlambat = $bpjs = $bpjstk = $koperasi = 0;
    $totalPotongan = 0;
...
<tr><td>Infaq Terlambat</td><td class="text-end">Rp {{ number_format($infaqTerlambat,0,',','.') }}</td></tr>
